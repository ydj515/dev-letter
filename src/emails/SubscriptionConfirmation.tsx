    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={paragraph}>
            AI-Powered Developer Insights 뉴스레터 구독을 환영합니다.
          </Text>
          <Text style={paragraph}>
            선택하신 관심 분야는 다음과 같습니다:
          </Text>
          <Section style={interestsSection}>
            {interests.map((interest, index) => (
              <Text key={index} style={interestItem}>• {interest}</Text>
            ))}
          </Section>
          <Text style={paragraph}>
            앞으로 <strong style={highlightText}>AI가 생성하는 최신 개발 트렌드, 심층 분석, 그리고 유용한 커리어 팁</strong>을
            정기적으로 보내드리겠습니다.
          </Text>
          <Text style={paragraph}>
          ...
          <Text style={footer}>
            <Link href="#" style={link}>구독 취소</Link> | <Link href="#" style={link}>문의하기</Link>
          </Text>
        </Container>
      </Body>
    </Html>
